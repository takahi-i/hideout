...
def resume_or_generate(func: Callable, func_args: Dict={}, stage: str=None, label: str=None) -> object:
    """
    ...
    Object : object
        ...
        specified func.
    """
    return Keeper(stage=stage).resume_or_generate(func=func, func_args=func_args, label=label)
